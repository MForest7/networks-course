...
1. Выберите один UDP-пакет. По этому пакету определите, сколько полей содержит UDP-заголовок.
   - 4
   ![](Screenshot_20240529_211338.png)
...
3. Значение в поле Length (Длина) – это длина чего?
   - Длина UDP-пакета (заголовок+данные)
4. Какое максимальное количество байт может быть включено в полезную нагрузку UDP-пакета?
   - Так как длина занимает 2 байта, а заголовок - 8 байт, то максимум в полезной нагрузке пакета может быть $(2^{16} - 1) - 8 = 65527$ байт
...
6. Какой номер протокола для протокола UDP? Дайте ответ и для шестнадцатеричной и
   ...
   - 17 (0x11)
   ![](Screenshot_20240529_212052.png)
7. Проверьте UDP-пакет и ответный UDP-пакет, отправляемый вашим хостом. Определите
   отношение между номерами портов в двух пакетах.
   - Порт отправителя в запросе соответствует порту получателя в ответе, и порт отправителя в ответе соответствует порту получателя в запросе
   ![](Screenshot_20240529_212219.png)
...
#### Скрины
![](Screenshot_20240529_212828.png)
...
#### Демонстрация работы
![](Screenshot_20240529_224524.png)
![](Screenshot_20240529_224613.png)
