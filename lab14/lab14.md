...
![](Screenshot_20240530_204231.png)
...
3. Каково значение исходного Ethernet-адреса? Какое устройство имеет такой Ethernet-адрес?
   ![](Screenshot_20240530_204431.png)
   - 8c:de:f9:c7:ba:34
   - Маршрутизатор в локальной сети, подключенный к внешней сети
...
1. Каковы шестнадцатеричные значения исходного и конечного адресов в Ethernet-кадре,
   ...
   ![](Screenshot_20240530_205759.png)
   - Исходный адрес - 8c:de:f9:c7:ba:34 (маршрутизатор)
   - Конечный адрес - 04:ed:33:cf:3d:43 (компьютер)
2. Содержится ли в ARP-сообщении IP-адрес отправителя?
   - Да, в поле sender IP address
...
4. Где в сообщении с ARP-откликом хранится Ethernet-адрес, который мы запрашивали на
   ...
   ![](Screenshot_20240530_210009.png)
   - Sender MAC address
